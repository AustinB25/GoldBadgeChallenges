...
namespace GoldBadgeChallenge_2_Claims
{
    public class ClaimsUI
    {
        ...
        public void SeeAllClaims()
        {
            ...
            foreach (Claim claim in _claimsRepository.SeeAllClaims())
            {
        ...
        public void TakeCareOfNextClaim()
        {
            ...
            {
                Console.Clear();
                Claim nextClaim = _claimsRepository.ViewNextClaimInQueue();
        ...
        {
            Claim claim = _claimsRepository.FindClaimById(id);
        ...
        {
            Claim seedClaim1 = new Claim(ClaimType.Car, "Car accident on 465.", 400.00, new DateTime(18, 4, 25), new DateTime(18, 4, 27));
            Claim seedClaim2 = new Claim(ClaimType.Home, "House fire in kitchen.", 4000.00, new DateTime(18, 4, 11), new DateTime(18, 4, 12));
            Claim seedClaim3 = new Claim(ClaimType.Theft, "Stolen pancakes.", 4.00, new DateTime(18, 4, 27), new DateTime(18, 6, 01));
